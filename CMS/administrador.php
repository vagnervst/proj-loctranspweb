    ...
    if( isset($_POST["formSubmit"]) ) {
        ...
        if( !FormValidator::has_empty_input( $listaRequiredInputs ) ) {
            ...
            if( empty($id) ) {
                ...
                if( count($dadosUsuario->buscar("usuario = '{$usuario}'")) > 0 ) {
                ...
                if( !empty($senha) && !empty($novaSenha) ) {                                        
                    ...
                    if( count($dadosUsuario->buscar("usuario = '{$usuario}'")) > 1 ) {
                        $erros[] = "Usuário já cadastrado!";                    
                    } else {
                        ...
                        if( \Tabela\UsuarioCS::login( $usuario, $senha ) ) {
                            ...
                            redirecionar_para("administrador.php?id={$id}");
                        } else {
        ...
        <div id="container">
            ...
            <div class="CMS_main" id="pag-cityshare-adm-edit">
                ...
                <div id="box-caminho">
                    ...
                    <a href="cityshare_adm.php" class="link-caminho">Administradores</a> &gt; 
                ...
                <div class="box-conteudo">
                    <div class="container-campos">
                        ...
                        <?php } ?>
                       <form method="post" action="administrador.php<?php echo ( !empty($id) )? "?id=" . $id : ""; ?>">
                            ...
                            <div class="box-botao">
                                ...
                                <?php if( !empty($id) ) { ?>
                                <a class="preset-botao" href="administrador.php?remover=true&id=<?php echo $id; ?>">Remover</a>
                                <?php } ?>
                            </div>
                        </form>
                    </div>
