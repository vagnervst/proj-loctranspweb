	...
	<body>
        <div id="container">
            ...
            <div class="CMS_main" id="pag-info-usuarios">
                ...
                <div id="box-caminho">
                    <a href="home.php" class="link-caminho" >Home</a> ><a href="clientes.php" class="link-caminho"> Clientes</a> > <a href="usuario.php" class="link-caminho" >Usuarios</a> > <a href="#" class="link-caminho" >Informações do usuário</a>
                </div>
