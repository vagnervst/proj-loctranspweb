	...
	<body>
        <div id="container">
            ...
            <div class="CMS_main" id="pag-cityshare-adm">
                ...
                <div id="box-caminho">
                    <a href="home.php" class="link-caminho" >Home</a> ><a href="cityshare.php" class="link-caminho"> City Share</a> > <a href="CMS_cityshare_adm.php" class="link-caminho" >Administradores</a>
                </div>
